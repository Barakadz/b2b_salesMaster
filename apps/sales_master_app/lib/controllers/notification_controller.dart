...
import 'package:sales_master_app/services/notifications_service.dart';
...
class NotificationController extends GetxController {
  ...
  RxBool unread = true.obs;

  RxBool loadingNotification = false.obs;
  RxBool notificationError = false.obs;
  ...
  Future<void> getNotification() async {
    ...
    PaginatedNotifications? paginatedNotification =
        await NotificationsService().getAllNotifications(unread: unread.value);

    if (paginatedNotification == null) {
      notificationError.value = true;
    } else {
      notifications.assignAll(paginatedNotification.notifications);
    }
