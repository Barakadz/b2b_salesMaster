...
//   // Unique keys for each branch
//   static final GlobalKey<NavigatorState> _homeBranchKey =
//       GlobalKey<NavigatorState>();
//   static final GlobalKey<NavigatorState> _clientsBranchKey =
//       GlobalKey<NavigatorState>();
//   static final GlobalKey<NavigatorState> _pipelineBranchKey =
//       GlobalKey<NavigatorState>();
//   static final GlobalKey<NavigatorState> _todolistBranchKey =
//       GlobalKey<NavigatorState>();
...
//       // StatefulShellRoute for main tabs
//       StatefulShellRoute.indexedStack(
//         builder: (context, state, navigationShell) =>
//             BaseView(navigationShell: navigationShell),
//         branches: [
//           StatefulShellBranch(
...
//           ),
//           StatefulShellBranch(
//             navigatorKey: _clientsBranchKey,
//             routes: [
//               GoRoute(
//                 name: AppRoutes.myClients.name,
//                 path: AppRoutes.myClients.path,
...
//           ),
//           StatefulShellBranch(
//             navigatorKey: _pipelineBranchKey,
//             routes: [
//               GoRoute(
//                 name: AppRoutes.pipeline.name,
//                 path: AppRoutes.pipeline.path,
...
//           ),
//           StatefulShellBranch(
//             navigatorKey: _todolistBranchKey,
//             routes: [
//               GoRoute(
//                 name: AppRoutes.todolist.name,
//                 path: AppRoutes.todolist.path,
